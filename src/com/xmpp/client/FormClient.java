...
public class FormClient extends Activity {
	...
	//服务器名称（域名）
	private static final String SERVER_NAME = "talk.google.com";
	//Xmpp 资源名称（比如连接的客户端名称等等） 自己自定义
	private static final String XMPP_RESOURCES = "gmail";
	
//	private String FROM_USERNAME = "laiyue";   //参与者
	private String FROM_USERNAME = "lwsxy5528@gmail.com";   //参与者
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		//从会话管理实例中创建一个会话
		final Chat newchat = cm.createChat(FROM_USERNAME, null);
